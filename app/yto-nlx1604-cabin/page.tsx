                    ...
                    <div className="row mb-3">
                      <div className="col-12 col-md-5">
                        ...
                        <div className="feedback">
                          ...
                          <a 
                            href={`https://wa.me/923115997569?text=${encodeURIComponent('Hi, I am interested in YTO-NLX1604 Cabin Wheeled Tractor. Please provide more details.')}`}
                            target="_blank"
                  ...
                  <div className="content_txt1">
                    <div className="row">
                      <div className="col-12">
                        ...
                        <RelatedProducts currentProduct="YTO-NLX1604" />
                        <div className="clearfix"></div>
