                    ...
                    <div className="row mb-3">
                      <div className="col-12 col-md-5">
                        ...
                        <div className="feedback">
                          ...
                          <a 
                            href={`https://wa.me/923115997569?text=${encodeURIComponent('Hi, I am interested in YTO-EF804 Wheeled Tractor. Please provide more details.')}`}
                            target="_blank"
                  ...
                  <div className="content_txt1">
                    <div className="row">
                      <div className="col-12">
                          ...
                          <RelatedProducts currentProduct="YTO-EF804" />
                          <div className="clearfix"></div>
