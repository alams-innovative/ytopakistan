...
export default function TractorDetail() {
  ...
  useEffect(() => {
    document.title = 'YTO-ESK550 | Agricultural Tractor | YTO';
    const metaDescription = document.querySelector('meta[name="description"]');
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    
    if (metaDescription) {
      metaDescription.setAttribute('content', "YTO-ESK550 wheeled tractor with 55hp power, YTO engine, 12F+4R transmission.");
    }
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'YTO-ESK550, Agricultural Tractor, YTO, Wheeled Tractor');
    }
  }, []);
  ...
  return (
    <div className="gridContainer clearfix">
            ...
            <div className="js-gallery-wrap">
              <div itemScope itemType="http://data-vocabulary.org/Product">
                <div itemProp="description">
                  <div>
                    <h2 itemProp="name" className="d-block d-md-none small_h2">YTO-ESK550 WHEELED TRACTOR</h2>
                    ...
                    <div className="row mb-3">
                      <div className="col-12 col-md-5">
                        <div className="left_pic">
                          <div className="left_pics">
                            <figure>
                              <a href="#" onClick={(e) => { e.preventDefault(); setSelectedImage('/tractors/yto-esk550/YTO-ESK550.jpg'); }}>
                                <img itemProp="image" src="/tractors/yto-esk550/YTO-ESK550.jpg" alt="YTO-ESK550 Wheeled Tractor" />
                              </a>
                            </figure>
                          </div>
                        </div>
                        ...
                        <div className="feedback">
                          ...
                          <a 
                            href={`https://wa.me/923115997569?text=${encodeURIComponent('Hi, I am interested in YTO-ESK550 Wheeled Tractor. Please provide more details.')}`}
                            target="_blank"
                      ...
                      <div className="col-12 col-md-7">
                        <h2 className="d-none d-md-block small_h2">YTO-ESK550 WHEELED TRACTOR</h2>
                        <div className="clearfix"></div>
                  ...
                  <div className="content_txt1">
                    <div className="row">
                      <div className="col-12">
                          <div className="etw_title1">Technical Specifications List — YTO-ESK550</div>
                            ...
                            <table className="table table-hover table-striped ke-zeroborder tables">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>540 (6splines): 35 / 1000 (2splines): 35</td>
                                </tr>
                                <tr>
                                  <td>Wheelbase</td>
                                  <td>2100mm</td>
                        ...
                        <RelatedProducts currentProduct="YTO-ESK550" />
                        <div className="clearfix"></div>
                        
                        <ContactForm productName="YTO-ESK550" showTitle={true} />
                        <div className="clearfix"></div>
                    <div className="clearfix"></div>
                      </div>
                    </div>
      ...
      <ImageModal 
        ...
        alt="YTO-ESK550 Tractor"
      />
      
      <InquiryModal 
        isOpen={isInquiryOpen}
        onClose={() => setIsInquiryOpen(false)}
        productName="YTO-ESK550"
      />
    </div>
  );
}
