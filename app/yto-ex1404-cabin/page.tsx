...
export default function TractorDetail() {
  ...
  useEffect(() => {
    document.title = 'YTO-EX1404 Cabin | Agricultural Tractor | YTO';
    const metaDescription = document.querySelector('meta[name="description"]');
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    
    if (metaDescription) {
      metaDescription.setAttribute('content', "YTO-EX1404 Cabin wheeled tractor with 140hp power, YTO engine, 12F+4R transmission, fully enclosed cabin.");
    }
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'YTO-EX1404 Cabin, Agricultural Tractor, YTO, Wheeled Tractor, Cabin Tractor');
    }
  }, []);
  ...
  return (
    <div className="gridContainer clearfix">
      ...
      <div id="container" className="etw_container">
        ...
        <div className="content content_white d-md-flex">
          <ProductSidebar 
            ...
            activeProduct="yto-ex1404-cabin" 
          />
            ...
            <div className="js-gallery-wrap">
              <div itemScope itemType="http://data-vocabulary.org/Product">
                <div itemProp="description">
                  <div>
                    <h2 itemProp="name" className="d-block d-md-none small_h2">YTO-EX1404 CABIN WHEELED TRACTOR</h2>
                    ...
                    <div className="row mb-3">
                      <div className="col-12 col-md-5">
                        <div className="left_pic">
                          <div className="left_pics">
                            <figure>
                              <a href="#" onClick={(e) => { e.preventDefault(); setSelectedImage('/tractors/yto-ex1404-cabin/YTO-EX1404-Cabin.jpg'); }}>
                                <img itemProp="image" src="/tractors/yto-ex1404-cabin/YTO-EX1404-Cabin.jpg" alt="YTO-EX1404 Cabin Wheeled Tractor" />
                              </a>
                            </figure>
                          </div>
                        </div>
                        ...
                        <div className="feedback">
                          ...
                          <a 
                            href={`https://wa.me/923115997569?text=${encodeURIComponent('Hi, I am interested in YTO-EX1404 Cabin Wheeled Tractor. Please provide more details.')}`}
                            target="_blank"
                      ...
                      <div className="col-12 col-md-7">
                        <h2 className="d-none d-md-block small_h2">YTO-EX1404 CABIN WHEELED TRACTOR</h2>
                        <div className="clearfix"></div>
                  ...
                  <div className="content_txt1">
                    <div className="row">
                      <div className="col-12">
                          <div className="etw_title1">Technical Specifications List — YTO-EX1404 Cabin</div>
                          <div className="table-responsive mb-2">
                            <table className="table table-hover table-striped ke-zeroborder tables">
                              <tbody>
                                <tr className="top">
                                  <td><strong>Model</strong></td>
                                  <td>YTO-EX1404 Cabin</td>
                                </tr>
                                <tr>
                                  <td>Engine</td>
                                  <td>YTO LR6M5-23</td>
                                ...
                                <tr>
                                  ...
                                  <td>5040*2380*2700mm (with cabin)</td>
                                </tr>
                                <tr>
                                  <td>Net weight</td>
                        ...
                        <div className="etw_related">
                          <ul>
                            ...
                            <li><a href="/yto-ex1054-canopy">YTO-EX1404 Canopy</a></li>
                        ...
                        <ContactForm productName="YTO-EX1404 Cabin" showTitle={true} />
                        <div className="clearfix"></div>
                    <div className="clearfix"></div>
                      </div>
                    </div>
      ...
      <ImageModal 
        ...
        alt="YTO-EX1404 Cabin Tractor"
      />
      
      <InquiryModal 
        isOpen={isInquiryOpen}
        onClose={() => setIsInquiryOpen(false)}
        productName="YTO-EX1404 Cabin"
      />
    </div>
  );
}
