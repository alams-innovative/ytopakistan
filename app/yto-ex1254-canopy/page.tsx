...
export default function TractorDetail() {
  ...
  useEffect(() => {
    document.title = 'YTO-EX1254 Canopy | Agricultural Tractor | YTO';
    const metaDescription = document.querySelector('meta[name="description"]');
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    
    if (metaDescription) {
      metaDescription.setAttribute('content', "YTO-EX1254 Canopy wheeled tractor with 125hp power, YTO engine, 12F+4R transmission, protective canopy.");
    }
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'YTO-EX1254 Canopy, Agricultural Tractor, YTO, Wheeled Tractor, Canopy Tractor');
    }
  }, []);
  ...
  return (
    <div className="gridContainer clearfix">
      ...
      <div id="container" className="etw_container">
        ...
        <div className="content content_white d-md-flex">
          <ProductSidebar 
            ...
            activeProduct="yto-ex1254-canopy" 
          />
            ...
            <div className="js-gallery-wrap">
              <div itemScope itemType="http://data-vocabulary.org/Product">
                <div itemProp="description">
                  <div>
                    <h2 itemProp="name" className="d-block d-md-none small_h2">YTO-EX1254 CANOPY WHEELED TRACTOR</h2>
                    ...
                    <div className="row mb-3">
                      <div className="col-12 col-md-5">
                        <div className="left_pic">
                          <div className="left_pics">
                            <figure>
                              <a href="#" onClick={(e) => { e.preventDefault(); setSelectedImage('/tractors/yto-ex1254-canopy/YTO-EX1254-Canopy.jpg'); }}>
                                <img itemProp="image" src="/tractors/yto-ex1254-canopy/YTO-EX1254-Canopy.jpg" alt="YTO-EX1254 Canopy Wheeled Tractor" />
                              </a>
                            </figure>
                          </div>
                        </div>
                        ...
                        <div className="feedback">
                          ...
                          <a 
                            href={`https://wa.me/923115997569?text=${encodeURIComponent('Hi, I am interested in YTO-EX1254 Canopy Wheeled Tractor. Please provide more details.')}`}
                            target="_blank"
                      ...
                      <div className="col-12 col-md-7">
                        <h2 className="d-none d-md-block small_h2">YTO-EX1254 CANOPY WHEELED TRACTOR</h2>
                        <div className="clearfix"></div>
                  ...
                  <div className="content_txt1">
                    <div className="row">
                      <div className="col-12">
                          <div className="etw_title1">Technical Specifications List — YTO-EX1254 Canopy</div>
                          <div className="table-responsive mb-2">
                            <table className="table table-hover table-striped ke-zeroborder tables">
                              <tbody>
                                <tr className="top">
                                  <td><strong>Model</strong></td>
                                  <td>YTO-EX1254 Canopy</td>
                                </tr>
                                <tr>
                                  <td>Engine</td>
                                  <td>YTO LR6M5-23</td>
                                ...
                                <tr>
                                  ...
                                  <td>4900*2350*2600mm (with canopy)</td>
                                </tr>
                                <tr>
                                  <td>Net weight</td>
                                  <td>5650kg (with canopy)</td>
                                </tr>
                                <tr>
                        ...
                        <div className="etw_related">
                          <ul>
                            <li><a href="/yto-ex1054">YTO-EX1254</a></li>
                            <li><a href="/yto-ex1054-cabin">YTO-EX1254 Cabin</a></li>
                        ...
                        <ContactForm productName="YTO-EX1254 Canopy" showTitle={true} />
                        <div className="clearfix"></div>
                    <div className="clearfix"></div>
                      </div>
                    </div>
      ...
      <ImageModal 
        ...
        alt="YTO-EX1254 Canopy Tractor"
      />
      
      <InquiryModal 
        isOpen={isInquiryOpen}
        onClose={() => setIsInquiryOpen(false)}
        productName="YTO-EX1254 Canopy"
      />
    </div>
  );
}
