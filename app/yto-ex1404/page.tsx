...
export default function TractorDetail() {
  ...
  useEffect(() => {
    document.title = 'YTO-EX1404 | Agricultural Tractor | YTO';
    const metaDescription = document.querySelector('meta[name="description"]');
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    
    if (metaDescription) {
      metaDescription.setAttribute('content', "YTO-EX1404 wheeled tractor with 140hp power, YTO engine, 12F+4R transmission.");
    }
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'YTO-EX1404, Agricultural Tractor, YTO, Wheeled Tractor');
    }
  }, []);
  ...
  return (
    <div className="gridContainer clearfix">
            ...
            <div className="js-gallery-wrap">
              <div itemScope itemType="http://data-vocabulary.org/Product">
                <div itemProp="description">
                  <div>
                    <h2 itemProp="name" className="d-block d-md-none small_h2">YTO-EX1404 WHEELED TRACTOR</h2>
                    ...
                    <div className="row mb-3">
                      <div className="col-12 col-md-5">
                        <div className="left_pic">
                          <div className="left_pics">
                            <figure>
                              <a href="#" onClick={(e) => { e.preventDefault(); setSelectedImage('/tractors/yto-ex1404/YTO-EXT1404.jpg'); }}>
                                <img itemProp="image" src="/tractors/yto-ex1404/YTO-EXT1404.jpg" alt="YTO-EX1404 Wheeled Tractor" />
                              </a>
                            </figure>
                          </div>
                        </div>
                        ...
                        <div className="feedback">
                          ...
                          <a 
                            href={`https://wa.me/923115997569?text=${encodeURIComponent('Hi, I am interested in YTO-EX1404 Wheeled Tractor. Please provide more details.')}`}
                            target="_blank"
                      ...
                      <div className="col-12 col-md-7">
                        <h2 className="d-none d-md-block small_h2">YTO-EX1404 WHEELED TRACTOR</h2>
                        <div className="clearfix"></div>
                  ...
                  <div className="content_txt1">
                    <div className="row">
                      <div className="col-12">
                          <div className="etw_title1">Technical Specifications List — YTO-EX1404</div>
                        ...
                        <ContactForm productName="YTO-EX1404" showTitle={true} />
                        <div className="clearfix"></div>
                    <div className="clearfix"></div>
                      </div>
                    </div>
      ...
      <ImageModal 
        ...
        alt="YTO-EX1404 Tractor"
      />
      
      <InquiryModal 
        isOpen={isInquiryOpen}
        onClose={() => setIsInquiryOpen(false)}
        productName="YTO-EX1404"
      />
    </div>
  );
}
