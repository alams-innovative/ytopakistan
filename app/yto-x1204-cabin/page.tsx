...
export default function TractorDetail() {
  ...
  useEffect(() => {
    document.title = 'YTO-X1204 Cabin | Agricultural Tractor | YTO';
    const metaDescription = document.querySelector('meta[name="description"]');
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    
    if (metaDescription) {
      metaDescription.setAttribute('content', "YTO-X1204 Cabin wheeled tractor with 120hp power, YTO engine, 12F+4R transmission, fully enclosed cabin.");
    }
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'YTO-X1204 Cabin, Agricultural Tractor, YTO, Wheeled Tractor, Cabin Tractor');
    }
  }, []);
  ...
  return (
    <div className="gridContainer clearfix">
                      ...
                      <div className="col-12 col-md-5">
                        <div className="left_pic">
                          <div className="left_pics">
                            <figure>
                              <a href="#" onClick={(e) => { e.preventDefault(); setSelectedImage('/tractors/yto-x1204-cabin/YTO-X1204-Cabin.jpg'); }}>
                                <img itemProp="image" src="/tractors/yto-x1204-cabin/YTO-X1204-Cabin.jpg" alt="YTO-X1204 Cabin Wheeled Tractor" />
                              </a>
                            </figure>
                          </div>
                        </div>
                        ...
                        <div className="feedback">
                          ...
                          <a 
                            href={`https://wa.me/923115997569?text=${encodeURIComponent('Hi, I am interested in YTO-X1204 Cabin Wheeled Tractor. Please provide more details.')}`}
                            target="_blank"
                  ...
                  <div className="content_txt1">
                    <div className="row">
                      <div className="col-12">
                          <div className="etw_title1">Technical Specifications List — YTO-X1204 Cabin</div>
                          <div className="table-responsive mb-2">
                            <table className="table table-hover table-striped ke-zeroborder tables">
                              <tbody>
                                <tr className="top">
                                  <td><strong>Model</strong></td>
                                  <td>YTO-X1204 Cabin</td>
                                </tr>
                                <tr>
                                  <td>Engine</td>
                                  <td>YTO LR6M5-23</td>
                                ...
                                <tr>
                                  ...
                                  <td>4800*2350*2700mm (with cabin)</td>
                                </tr>
                                <tr>
                                  <td>Net weight</td>
                                  <td>5500kg (with cabin)</td>
                                </tr>
                                <tr>
                        ...
                        <ContactForm productName="YTO-X1204 Cabin" showTitle={true} />
                        <div className="clearfix"></div>
                    <div className="clearfix"></div>
                      </div>
                    </div>
      ...
      <ImageModal 
        ...
        alt="YTO-X1204 Cabin Tractor"
      />
      
      <InquiryModal 
        isOpen={isInquiryOpen}
        onClose={() => setIsInquiryOpen(false)}
        productName="YTO-X1204 Cabin"
      />
    </div>
  );
}
