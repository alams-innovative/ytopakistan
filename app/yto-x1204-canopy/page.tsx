...
export default function TractorDetail() {
  ...
  useEffect(() => {
    document.title = 'YTO-X1204 Canopy | Agricultural Tractor | YTO';
    const metaDescription = document.querySelector('meta[name="description"]');
    const metaKeywords = document.querySelector('meta[name="keywords"]');
    
    if (metaDescription) {
      metaDescription.setAttribute('content', "YTO-X1204 Canopy wheeled tractor with 120hp power, YTO engine, 12F+4R transmission, protective canopy.");
    }
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'YTO-X1204 Canopy, Agricultural Tractor, YTO, Wheeled Tractor, Canopy Tractor');
    }
  }, []);
  ...
  return (
    <div className="gridContainer clearfix">
      ...
      <div id="container" className="etw_container">
        ...
        <div className="content content_white d-md-flex">
          <ProductSidebar 
            ...
            activeProduct="yto-x1204-canopy" 
          />
            ...
            <div className="js-gallery-wrap">
              <div itemScope itemType="http://data-vocabulary.org/Product">
                <div itemProp="description">
                  <div>
                    <h2 itemProp="name" className="d-block d-md-none small_h2">YTO-X1204 CABIN WHEELED TRACTOR</h2>
                    ...
                    <div className="row mb-3">
                      <div className="col-12 col-md-5">
                        <div className="left_pic">
                          <div className="left_pics">
                            <figure>
                              <a href="#" onClick={(e) => { e.preventDefault(); setSelectedImage('/tractors/yto-x1204-canopy/YTO-X1204-Canopy.jpg'); }}>
                                <img itemProp="image" src="/tractors/yto-x1204-canopy/YTO-X1204-Canopy.jpg" alt="YTO-X1204 Canopy Wheeled Tractor" />
                              </a>
                            </figure>
                          </div>
                        </div>
                        ...
                        <div className="feedback">
                          ...
                          <a 
                            href={`https://wa.me/923115997569?text=${encodeURIComponent('Hi, I am interested in YTO-X1204 Canopy Wheeled Tractor. Please provide more details.')}`}
                            target="_blank"
                      ...
                      <div className="col-12 col-md-7">
                        <h2 className="d-none d-md-block small_h2">YTO-X1204 CABIN WHEELED TRACTOR</h2>
                        <div className="clearfix"></div>
                        <div className="etw_title1">Main Characteristics</div>
                        <div className="clearfix"></div>
                        <ul className="item">
                          <li><strong>Fully Enclosed Canopy:</strong> Comfortable and weather-protected operator environment providing shade and protection for extended operation;</li>
                  ...
                  <div className="content_txt1">
                    <div className="row">
                      <div className="col-12">
                          <div className="etw_title1">Technical Specifications List — YTO-X1204 Canopy</div>
                          <div className="table-responsive mb-2">
                            <table className="table table-hover table-striped ke-zeroborder tables">
                              <tbody>
                                <tr className="top">
                                  <td><strong>Model</strong></td>
                                  <td>YTO-X1204 Canopy</td>
                                </tr>
                                <tr>
                                  <td>Engine</td>
                                  <td>YTO LR6M5-23</td>
                                ...
                                <tr>
                                  ...
                                  <td>540 (6splines): 58 / 1000 (2splines): 72</td>
                                </tr>
                                <tr>
                                  <td>Wheelbase</td>
                                  <td>2550mm</td>
                                ...
                                <tr>
                                  ...
                                  <td>4800*2350*2700mm (with canopy)</td>
                                </tr>
                                <tr>
                                  <td>Net weight</td>
                                  <td>5500kg (with canopy)</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td>Fully enclosed canopy with climate control, sound insulation, ergonomic seating, and enhanced visibility</td>
                                </tr>
                                <tr>
                        ...
                        <div className="etw_related">
                          <ul>
                            <li><a href="/yto-ex1054">YTO-X1204</a></li>
                            <li><a href="/yto-ex1054-canopy">YTO-X1204 Canopy</a></li>
                            ...
                            <li><a href="/yto-ex1404-canopy">YTO-EX1404 Canopy</a></li>
                            <li><a href="/yto-x1204-canopy">YTO-X1204 Canopy</a></li>
                          </ul>
                        </div>
                        <div className="clearfix"></div>
                        
                        <ContactForm productName="YTO-X1204 Canopy" showTitle={true} />
                        <div className="clearfix"></div>
                    <div className="clearfix"></div>
                      </div>
                    </div>
      ...
      <ImageModal 
        ...
        alt="YTO-X1204 Canopy Tractor"
      />
      
      <InquiryModal 
        isOpen={isInquiryOpen}
        onClose={() => setIsInquiryOpen(false)}
        productName="YTO-X1204 Canopy"
      />
    </div>
  );
}
